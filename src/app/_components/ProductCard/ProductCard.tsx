...
import { FaRegEye, FaStar, FaStarHalfAlt, FaRegStar, FaRegHeart } from "react-icons/fa";
      ...
      <div key={product._id} className="py-2 px-1 w-full lg:w-1/4 xl:w-1/5">
        <div className="p-4 h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-2 border rounded-lg relative">
          ...
          <div className="flex flex-col gap-2 absolute top-2 inset-e-2">
            <AddToWishlistBtn productId = {product._id} content = {<FaRegHeart />} style="size-8 rounded-full bg-white shadow-sm flex justify-center items-center text-md text-[#4A5565] hover:text-[#FB2C36] transition-all duration-300 cursor-pointer"/>
